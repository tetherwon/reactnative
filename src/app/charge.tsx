...
const MISSIONS = {
  bug: {
    ...
    desc: '서비스 오류나 불편한 점, 개선 아이디어를 알려주세요. 내용이 채택되면 기여도에 따라 최대 2,000캐시를 드려요. 아래 버튼을 눌러 카카오톡 채널로 제보 내용을 보내주시면 확인 후 지급해 드립니다.',
    cta: '카톡 채널로 버그 제보하기',
  },
  review: {
    title: '리뷰 쓰기',
    reward: '최초 1회 · 200캐시',
    desc: '쇼핑로그를 이용한 솔직한 리뷰를 남겨주세요. 최초 1회에 한해 200캐시를 드려요. 아래 버튼을 눌러 카카오톡 채널로 작성한 리뷰(캡처)를 보내주시면 확인 후 지급해 드립니다.',
    cta: '카톡 채널로 리뷰 남기기',
  },
} as const;
